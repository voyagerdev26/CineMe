...
const SeatLayout = () => {
  ...
  // different component for seat structure
  ...
  const bookTickets = async ()=>{
    try {
      if(!user){// means user is not logged in
        return toast.error("Kindly login to book tickets.")
      }
      ...
      if(data.success){
        ...
        window.location.href = data.url; // user redirected to payment link
      }
      else{
        toast.error(data.message);
      }
